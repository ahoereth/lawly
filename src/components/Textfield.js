...
class Textfield extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    const { required, pattern, error, disabled, value } = this.props;
    if (
    ...
    if (error && !pattern) {
      ...
      // its invalid class gets reset. We have to put it again if the input is
      // specifically set as "invalid"
      this.setAsInvalid();
    }
  }
