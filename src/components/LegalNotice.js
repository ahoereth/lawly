    ...
    <Cell col={10} offsetDesktop={1} tablet={6} offsetTablet={1} phone={6}>
      <Card shadow={1}>
        ...
        <CardText>
          <ol>
            <li>
              Für eine verbesserte Funktionalität der Applikation bei
              getrennter oder Eingeschränkter Internetverbindung werden Daten
              in eingeschränktem Umfang in Ihrem Browser zwischengespeichert.
              Bei diesen handelt es sich, außgenommen ihrer E-Mail-Adresse
              falls sie ein Benutzerkonto angelegt haben, um keine
              personenbezogenen Daten.
            </li>
            <li>
              Im Zusammenhang mit einem auf Ihren Wunsch hin möglicherweise
              angelegten Benutzerkonto speichern wir Ihre E-Mail-Adresse in
              Verbindung mit von Ihnen angelegten Gesetzessammlungen. Ihre
              Daten sind durch Ihr persönliches Passwort geschützt und für
              andere ohne Ihre explizite Einwilligung (zum Beispiel ihm Rahmen
              von Kollaboration) nicht zugänglich.
            </li>
            <li>
              ...
              durch Sie ermöglicht. Die durch den Cookie erzeugten
              ...
              übertragen und dort gespeichert. Lawly setzt hierbei allerdings
              auf IP-Anonymisierung, wodurch Ihre IP-Adresse von Google
              ...
              und dort gekürzt. Google wird diese Informationen benutzen, um
              ...
              verbundene Dienstleistungen zu erbringen. Google wird in keinem
